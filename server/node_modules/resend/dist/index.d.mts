...
type RemoveApiKeyResponseSuccess = Pick<ApiKey, 'id'> & {
  object: 'api_key';
  deleted: boolean;
};
...
type ContactImportStatus = 'queued' | 'in_progress' | 'completed' | 'failed';
interface ContactImportCounts {
  total: number;
  created: number;
  updated: number;
  skipped: number;
...
type ContactImportOnConflict = 'upsert' | 'skip';
type ContactImportPropertyType = 'string' | 'number' | 'boolean';
interface ContactImportPropertyMapping {
  column: string;
  type?: ContactImportPropertyType;
}
interface ContactImportColumnMap {
  email?: string;
  firstName?: string;
  lastName?: string;
  unsubscribed?: string;
...
interface ContactImportSegment {
  id: string;
}
interface ContactImportTopic {
  id: string;
  subscription: 'opt_in' | 'opt_out';
}
interface CreateContactImportOptions {
  file: Blob;
...
interface CreateContactImportRequestOptions extends PostOptions {}
interface CreateContactImportResponseSuccess {
  object: 'contact_import';
  id: string;
}
type CreateContactImportResponse = Response<CreateContactImportResponseSuccess>;
//#endregion
//#region src/contacts/imports/interfaces/get-contact-import.interface.d.ts
type GetContactImportResponseSuccess = ContactImport;
type GetContactImportResponse = Response<GetContactImportResponseSuccess>;
//#endregion
//#region src/contacts/imports/interfaces/list-contact-imports.interface.d.ts
type ListContactImportsOptions = PaginationOptions & {
  status?: ContactImportStatus;
};
type ListContactImportsResponseSuccess = PaginatedData<ContactImport[]>;
type ListContactImportsResponse = Response<ListContactImportsResponseSuccess>;
//#endregion
...
type DomainClaimStatus = 'pending' | 'verified' | 'completed' | 'blocked' | 'expired' | 'superseded' | 'canceled' | 'failed';
type DomainClaimBlockedReason = 'grace_period' | 'recent_owner_activity' | 'pending_scheduled_emails';
interface DomainClaimRecord {
  type: 'TXT';
  name: string;
  value: string;
  ttl: 'Auto';
...
interface ClaimDomainRequestOptions extends PostOptions {}
interface ClaimDomainResponseSuccess extends DomainClaim {
  object: 'domain_claim';
}
type ClaimDomainResponse = Response<ClaimDomainResponseSuccess>;
//#endregion
//#region src/domains/claims/interfaces/get-domain-claim.interface.d.ts
interface GetDomainClaimResponseSuccess extends DomainClaim {
  object: 'domain_claim';
}
type GetDomainClaimResponse = Response<GetDomainClaimResponseSuccess>;
//#endregion
//#region src/domains/claims/interfaces/verify-domain-claim.interface.d.ts
interface VerifyDomainClaimResponseSuccess extends DomainClaim {
  object: 'domain_claim';
}
type VerifyDomainClaimResponse = Response<VerifyDomainClaimResponseSuccess>;
//#endregion
...
interface ForwardReceivingEmailRequestOptions extends PostOptions, IdempotentRequest {}
...
interface GetReceivingEmailOptions {
  /**
...
interface BatchAddSuppressionsOptions {
  emails: string[];
}
interface BatchAddSuppressionsResponseSuccess {
  data: {
    object: 'suppression';
    id: string;
  }[];
}
type BatchAddSuppressionsResponse = Response<BatchAddSuppressionsResponseSuccess>;
//#endregion
...
interface BatchRemoveSuppressionsResponseSuccess {
  data: {
    object: 'suppression';
    id: string;
    deleted: boolean;
...
type BatchRemoveSuppressionsResponse = Response<BatchRemoveSuppressionsResponseSuccess>;
//#endregion
...
interface AddSuppressionOptions {
  email: string;
}
interface AddSuppressionResponseSuccess {
  object: 'suppression';
  id: string;
}
type AddSuppressionResponse = Response<AddSuppressionResponseSuccess>;
//#endregion
//#region src/suppressions/interfaces/suppression-list-entry.d.ts
type SuppressionOrigin = 'bounce' | 'complaint' | 'manual';
...
type SuppressionListEntry = Omit<Suppression, 'object'>;
//#endregion
//#region src/suppressions/interfaces/get-suppression.interface.d.ts
type GetSuppressionResponseSuccess = Suppression;
type GetSuppressionResponse = Response<GetSuppressionResponseSuccess>;
//#endregion
//#region src/suppressions/interfaces/list-suppressions.interface.d.ts
type ListSuppressionsOptions = PaginationOptions & {
  origin?: SuppressionOrigin;
};
type ListSuppressionsResponseSuccess = PaginatedData<SuppressionListEntry[]>;
type ListSuppressionsResponse = Response<ListSuppressionsResponseSuccess>;
//#endregion
//#region src/suppressions/interfaces/remove-suppression.interface.d.ts
interface RemoveSuppressionResponseSuccess {
  object: 'suppression';
  id: string;
  deleted: boolean;
}
type RemoveSuppressionResponse = Response<RemoveSuppressionResponseSuccess>;
//#endregion
